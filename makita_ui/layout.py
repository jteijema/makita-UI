...
def _main_layout():
    ...
    return [            
        [sg.Text("Makita UI!", font=("Arial", 14, "bold"))],
        ...
        [sg.Button("Exit", button_color=("white", sg.theme_background_color()), key="-EXIT-", pad=((0, 0), (10, 0))), sg.Push(), sg.Text("Version 0.3.1", font=("Arial", 8))]
    ]
